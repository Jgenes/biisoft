...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				<p>&nbsp;</p>
				<a href="pos.php" class="btn btn-dark">Back to POS</a><button class="btn btn-info float-right" onClick=" printdiv('pintContent2');">PRINT</button>
				<!-- content start here -->
				<p>&nbsp;</p>
	...
	<table>
			...
			<tr>
				<td><h1><tt><center><strong>Destination 3 Degrees Hotel</strong></center></tt></h1></td>
			</tr>
...
<tr>
					<td><h2><tt><center>www.destination3degrees.com</center>
...
<ul>
	<?php 
		$soldItems = $mysqli->query("SELECT * FROM orders") or die("ERROR 500");
		// echo $id;
		while($rows = $soldItems->fetch_assoc()):
	 ?>
	<h1><li><tt><strong><?php echo $rows['orders_name']; ?>  &nbsp;&nbsp;&nbsp;[<?php echo $rows['orders_qty']; ?>]		&nbsp;&nbsp;<?php echo $rows['orders_price']." TZs"; ?></strong>
</tt></li></h1>
...
<?php 
  $selectOrders = $mysqli->query("SELECT SUM(orders_total) AS total FROM orders") or die("ERROR 5000");
