...
// calculate the profit per qty 
    // 1 select prifit per @ pc form products page
...
// check if the amount entered is equal to newtotal
	elseif ($amount < $newTotal) {
		# code...
        echo "<script> alert('Amount is less!')</script>";
...
$orders = $mysqli->query("SELECT * FROM orders") or die("ERROR 5000");
...
// DELETE INSERT ORDER
$mysqli->query("DELETE FROM  orders") or die("ERROR 5000");
...
?>
 ...
 <input type="search" id="pSearch" name="pSearch" class="form-control"
					...
					<form method="POST" action="">
        				...
        				value="1" class="inputSmall"> <?php echo $rows['products_price'];?> TZs &nbsp;&nbsp;
        		...
        		<div class="col-md-5 light-grey">
        			...
        			<thead>
        				...
        				<tbody>
        					<!-- Orders list -->
        					<?php 
						$selectOrders = $mysqli->query("SELECT * FROM orders") or die("ERROR 5000");
        ...
        $selectOrders = $mysqli->query("SELECT SUM(orders_qty) AS qty,SUM(orders_total) AS total FROM orders") or die("ERROR 5000");
        					...
        					<h5>Total : <?php echo $rows['total']." TZs";?></h5>
        					<h5>Discount : <input type="text" name="discount" value="0" class="inputMd"></h5>
 ...
 -->
        ...
        <input type="text" name="amount" class="form-control" placeholder="Enter Amount" required>
        					...
        					<!-- pay button -->
                            <a href="bill.php" class="btn btn-small btn-grey">Print Bill</a>
        					<button data-toggle="modal" data-target="#pay" class="btn btn-small btn-info" >Pay by Cash</button>
                             <button data-toggle="modal" data-target="#credit" class="btn btn-small btn-dark float-right" >Credit</button>
